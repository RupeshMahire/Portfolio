...
export default function Overlay({ progress }: OverlayProps) {
    ...
    return (
        <div className="absolute inset-0 pointer-events-none z-10 flex flex-col justify-center select-none">
            ...
            >
                <div>
                    <h1 className="text-6xl md:text-8xl font-black tracking-tighter text-white drop-shadow-2xl mb-4">
                        {portfolioData.personal.name}
                    </h1>
                    <p className="text-xl md:text-2xl font-light text-gray-200 tracking-widest uppercase drop-shadow-md">
            ...
            >
                <div className="max-w-3xl">
                    ...
                    <p className="mt-6 text-xl text-gray-100 max-w-xl drop-shadow-md font-medium">
            ...
            >
                <div className="max-w-3xl">
                    ...
                    <p className="mt-6 text-xl text-gray-100 drop-shadow-md font-medium">
